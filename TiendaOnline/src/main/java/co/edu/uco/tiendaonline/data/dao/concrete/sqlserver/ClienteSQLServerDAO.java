...
final var sentencia = new StringBuilder();
		...
		try(final var sentenciaPreparada = getConexion().prepareStatement(sentencia.toString()) ) {
			...
			var mensajeUsuario = CatalogoMensajes.obtenerContenido(CodigoMensaje.M0000059);
			var mensajeTecnico = CatalogoMensajes.obtenerContenido(CodigoMensaje.M0000060);
			throw DataTiendaOnlineException.crear(excepcion, mensajeUsuario,mensajeTecnico);
		}catch(final Exception excepcion){
			var mensajeUsuario = CatalogoMensajes.obtenerContenido(CodigoMensaje.M0000059);
			var mensajeTecnico = CatalogoMensajes.obtenerContenido(CodigoMensaje.M0000061);
			throw DataTiendaOnlineException.crear(excepcion,mensajeUsuario,mensajeTecnico);
		}
...
final var sentencia = new StringBuilder();
	    ...
	    try(final var sentenciaPreparada = getConexion().prepareStatement(sentencia.toString()) ) {
	        ...
	        var mensajeUsuario = CatalogoMensajes.obtenerContenido(CodigoMensaje.M0000062);
	        var mensajeTecnico = CatalogoMensajes.obtenerContenido(CodigoMensaje.M0000063);
	        throw DataTiendaOnlineException.crear(excepcion, mensajeUsuario, mensajeTecnico);
	    } catch (final Exception excepcion) {
	        var mensajeUsuario = CatalogoMensajes.obtenerContenido(CodigoMensaje.M0000062);
	        var mensajeTecnico = CatalogoMensajes.obtenerContenido(CodigoMensaje.M0000064);
	        throw DataTiendaOnlineException.crear(excepcion, mensajeUsuario, mensajeTecnico);
	    }
